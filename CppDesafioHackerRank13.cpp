...
class Student{
    ...
    public:
        ...
        void set_standard ( int argStandard){
            standard = argStandard;
        }
        void set_first_name (string argFirst_Name){
            first_name = argFirst_Name;
        }
        void set_last_name (string argLast_Name){
            last_name = argLast_Name;
        }
        int get_age(){
            return age;
        }
        ...
        string to_string(){
            string ageS = std::to_string(age);
            string standardS = std::to_string(standard);
