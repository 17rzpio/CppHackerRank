...
You need to modify the class D and implement the function which sets D's val to new_val by manipulating the value by only calling the func defined in classes A, B and C. update_val
